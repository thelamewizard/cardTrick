...
def displayit(fulldeck):
    ...
    message_display('Then pick one card from the list and remember it',400,150,20,color=BLACK)
    for i in cardlist: 
    ...
    while True:
        ...
        for event in pygame.event.get():
            if len(chosen)==15:
                gameDisplay.blit(randomcardsbuttoncover,(250,450))
                ...
                button(250,450,250,40,YELLOW,(255, 0, 175),str(15-len(chosen))+' random cards!',16,getrandom15)
                ...
                for i in cardlist:    
                    if (fulldeck.cardpositions[i][0]< event.pos[0]<fulldeck.cardpositions[i][0]+13) and (fulldeck.cardpositions[i][1]< event.pos[1]<fulldeck.cardpositions[i][1]+85):
                        if fulldeck.cardpositions[i][1]<249:
                            ...
                            chosen.remove(i)
                            gameDisplay.blit(cardscover,(40,220))
